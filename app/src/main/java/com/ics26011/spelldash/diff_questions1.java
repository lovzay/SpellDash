...
public class diff_questions1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diff_questions1);
    ...
    public void openDiffResults1() {
        Intent intent = new Intent(this, diff_results1.class);
